...
contract TestUnitLinearBondingCurve is ConstantsFixture, DeploymentLinearBondingCurve {
    ...
    function setUp() public virtual override {
        ...
        acceptedToken = IERC20(address(new MockERC20("TestAcceptedToken", "BUY", 18)));
    ...
    function test_RevertWhen_unexpectedETH_purchase() external asBuyer {
    ...
    function test_RevertWhen_exceedsCap_purchase() external asBuyer {
    ...
    function test_ForState_acceptedToken_purchase() external asBuyer {
        ...
        uint256 changeInAliceBalAcceptedToken = alicePostBalAcceptedToken > alicePreBalAcceptedToken
            ? (alicePostBalAcceptedToken - alicePreBalAcceptedToken)
            : (alicePreBalAcceptedToken - alicePostBalAcceptedToken);
    ...
    function test_ForState_SaleToken_purchase() external asBuyer {
