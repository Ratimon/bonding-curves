...
contract LinearBondingCurveInvariants is StdInvariant, Test, ConstantsFixture, DeploymentLinearBondingCurve  {
    ...
    function setUp() public override {
        ...
        acceptedToken = IERC20(address(new MockERC20("TestSaleToken", "SELL", 18)));
        ...
        _buyerManager = new InvariantBuyerManager(address(linearBondingCurve), address(acceptedToken),  address(saleToken) );
    ...
    function invariant_Poolbalance_eq_saleTokenBalance() public {
        ...
        assertEq( unwrap( LinearCurve( address(linearBondingCurve)).getPoolBalance( acceptedTokenSupply ) ), unwrap(linearBondingCurve.totalPurchased() ));
    }
